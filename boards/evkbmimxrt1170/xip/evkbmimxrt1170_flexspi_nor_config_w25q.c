...
#define FLASH_QE_DIS_VAL  0x00
#define FLASH_QE_DIS_CMD  0x31
    ...
    .memConfig =
        {
            ...
            /* Prepare setting value for QE Register in flash */
            .configCmdArgs[0] = FLASH_QE_DIS_VAL,
            .lookupTable =
                {
                    // Read LUTs
                    ...
                    // Configure QE LUTs
                    [4 * 12 + 0] = FLEXSPI_LUT_SEQ(CMD_SDR, FLEXSPI_1PAD, FLASH_QE_DIS_CMD, WRITE_SDR, FLEXSPI_1PAD, 0x01),
